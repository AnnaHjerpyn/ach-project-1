    ...
    class PageController extends ContentController
    {
        ...
        protected function init()
        {
            ...
            Requirements::combine_files(
                'all.js',
                [
                    $loader->findThemedJavascript('vendor/jquery-3.6.0.min.js'),
                    $loader->findThemedJavascript('vendor/bootstrap.bundle.min.js'),
                    $loader->findThemedJavascript('vendor/popper.min.js'),
